...
public struct GLFWError: Error {
    public let underlyingError: GLFWUnderlyingError
    public let description: String?
    
    internal init(underlyingError: GLFWUnderlyingError, description: String? = nil) {
        self.underlyingError = underlyingError
        self.description = description
    }
    
    internal init(underlyingError: Int32, description: UnsafePointer<CChar>?) {
        self.init(underlyingError: GLFWUnderlyingError(rawValue: underlyingError) ?? .unknown, description: description.flatMap(String.init(cString:)))
    }
}

@frozen
public enum GLFWUnderlyingError: Int32, Error, Equatable {
    case none = 0
